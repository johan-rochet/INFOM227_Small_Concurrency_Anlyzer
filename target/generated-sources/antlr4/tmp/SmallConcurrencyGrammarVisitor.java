...
public interface SmallConcurrencyGrammarVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SmallConcurrencyGrammarParser#bop}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBop(SmallConcurrencyGrammarParser.BopContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SmallConcurrencyGrammarParser#threadDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitThreadDecl(SmallConcurrencyGrammarParser.ThreadDeclContext ctx);
	/**
	 * Visit a parse tree produced by {@link SmallConcurrencyGrammarParser#lockVarDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLockVarDecl(SmallConcurrencyGrammarParser.LockVarDeclContext ctx);
	/**
	 * Visit a parse tree produced by {@link SmallConcurrencyGrammarParser#unlockVarDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitUnlockVarDecl(SmallConcurrencyGrammarParser.UnlockVarDeclContext ctx);
}